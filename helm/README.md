...
[Create new kubernetes certificates](./tls.ms) or if you already have a Kubernetes TLS certificate please link it to the ManagedCertificate you created previously with:
